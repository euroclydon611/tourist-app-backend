 ...
 */
export const createDestination = catchAsyncErrors(
 ...
 * @access  Protected/Admin
 */
export const updateDestination = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const fetchDestinations = catchAsyncErrors(
...
export const getDestinationById = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    const { id } = req.params;
...
export const destinationReview = catchAsyncErrors(
  async (req: Request, res: Response, next: NextFunction) => {
    try {
